...
$string['alreadysignedup'] = 'You have already signed-up for this Booking-Form activity.';
...
$string['calendareventdescriptionbooking'] = 'You are booked for this <a href="{$a}">Booking-Form session</a>.';
$string['calendareventdescriptionsession'] = 'You have created this <a href="{$a}">Booking-Form session</a>.';
...
$string['crontask'] = 'Booking-Form maintenance jobs';
...
$string['error:addalreadysignedupattendee'] = '{$a} is already signed-up for this Booking-Form activity.';
...
$string['error:couldnotaddtrainer'] = 'Could not save new Booking-Form session trainer';
...
$string['error:couldnotdeletetrainer'] = 'Could not delete a Booking-Form session trainer';
...
$string['error:couldnotupdatef2frecord'] = 'Could not update Booking-Form signup record in database';
...
$string['error:cronprefix'] = 'Error: Booking-Form cron:';
...
$string['error:f2ffailedupdatestatus'] = 'Booking-Form failed to update the user\'s status';
...
$string['error:incorrectcoursemodulesession'] = 'Course Module Booking-Form Session was incorrect';
$string['error:incorrectbookingformid'] = 'Booking-Form ID was incorrect';
...
$string['error:mustspecifycoursemodulebookingform'] = 'Must specify a course module or a Booking-Form ID';
...
$string['error:nopermissiontosignup'] = 'You don\'t have permission to signup to this Booking-Form session.';
...
$string['error:signedupinothersession'] = 'You are already signed up in another session for this activity. You can only sign up for one session per Booking-Form activity.';
...
$string['bookingform'] = 'Booking-Form';
$string['bookingform:addinstance'] = 'Add instance';
$string['bookingform:addattendees'] = 'Add attendees to a Booking-Form session';
$string['bookingform:configurecancellation'] = 'Allow the configuration of sign-up cancellations, upon adding/editing a face-to-face activity.';
$string['bookingform:editsessions'] = 'Add, edit, copy and delete Booking-Form sessions';
$string['bookingform:overbook'] = 'Sign-up to full sessions.';
$string['bookingform:removeattendees'] = 'Remove attendees from a Booking-Form session';
$string['bookingform:signup'] = 'Sign-up for a session';
...
$string['bookingformname'] = 'Booking-Form name';
$string['bookingformsession'] = 'Booking-Form session';
...
$string['modulename'] = 'Booking-Form';
$string['modulenameplural'] = 'Booking-Form';
...
$string['nobookingforms'] = 'There are no Booking-Form activities';
...
$string['order'] = 'Order';
$string['place'] = 'Room';
$string['placeholder:bookingformname'] = '[bookingformname]';
...
$string['pluginadministration'] = 'Booking-Form administration';
$string['pluginname'] = 'Booking-Form';
$string['points'] = 'Points';
$string['pointsplural'] = 'Points';
$string['previoussessions'] = 'Previous sessions';
$string['previoussessionslist'] = 'List of all past sessions for this Booking-Form activity';
$string['printversionid'] = 'Print version: without name';
$string['printversionname'] = 'Print version: with name';
$string['privacy:metadata:bookingform_signups'] = 'User signups to Face-to-face sessions';
$string['privacy:metadata:bookingform_signups:id'] = 'The id of the signup';
$string['privacy:metadata:bookingform_signups:sessionid'] = 'The session id';
$string['privacy:metadata:bookingform_signups:mailedreminder'] = 'The time a reminder was last sent';
$string['privacy:metadata:bookingform_signups:discountcode'] = 'The discount code entered by the user';
$string['privacy:metadata:bookingform_signups:notificationtype'] = 'How the user would like to be notified.';
$string['privacy:metadata:bookingform_signups_status'] = 'The Status of a user signup to a session';
$string['privacy:metadata:bookingform_signups_status:signupid'] = 'The id of the signup';
$string['privacy:metadata:bookingform_signups_status:statuscode'] = 'The status of the signup eg cancelled,declined,fully_attended';
$string['privacy:metadata:bookingform_signups_status:grade'] = 'The grade assigned for attending the session';
$string['privacy:metadata:bookingform_signups_status:note'] = 'Stores the reason for a cancelled session';
$string['privacy:metadata:bookingform_signups_status:timecreated'] = 'The time the signup was created.';
$string['privacy:metadata:bookingform_session_roles'] = 'Lists users with a trainer role in a bookingform session';
$string['privacy:metadata:userid'] = 'The ID of the user who accessed the Booking-Form activity';
$string['privacy:metadata:roleid'] = 'The role ID of the user.';
$string['really'] = 'Do you really want to delete all results for this Booking-Form?';
...
$string['room'] = 'Room';
$string['save_add_new'] = 'Save changes and create another session';
...
$string['search:activity'] = 'Bookingform activities';
...
$string['setting:defaultconfirmationsubjectdefault'] = 'Course booking confirmation: [bookingformname], [starttime]-[finishtime], [sessiondate]';
...
$string['setting:defaultremindersubjectdefault'] = 'Course booking reminder: [bookingformname], [starttime]-[finishtime], [sessiondate]';
...
Room:   [session:room]
';
$string['setting:defaultrequestsubjectdefault'] = 'Course booking request: [bookingformname], [starttime]-[finishtime]';
...
$string['setting:defaultwaitlistedsubjectdefault'] = 'Waitlisting advice for [bookingformname]';
...
$string['setting:sessionroles'] = 'Users assigned to the selected roles in a course can be tracked with each Booking-Form session';
...
$string['signupforthissession'] = 'Sign-up for this Booking-Form session';
...
$string['upcomingsessionslist'] = 'List of all upcoming sessions for this Booking-Form activity';
$string['updaterequests'] = 'Update requests';
$string['upgradeprocessinggrades'] = 'Processing Booking-Form grades, this may take a while if there are many sessions...';
...
// Help Text.
$string['allowoverbook_help'] = 'When "Allow overbooking" is checked, learners will be able to sign up for a Booking-Form session even if it is already full.<br />
...
$string['approvalreqd_help'] = 'When "Approval required" is checked, a learner will need approval from their manager to be permitted to attend a Booking-Form session.';

$string['cancellationinstrmngr'] = '# Notice for manager';
$string['cancellationinstrmngr_help'] = 'When **Send notice to manager** is checked, the text in the **Notice for manager** field is sent to a learner\'s manager advising that they have cancelled a Booking-Form booking.';
...
$string['confirmationinstrmngr_help'] = 'When "Send notice to manager" is checked, the text in the "Notice for manager" field is sent to a manager advising that a staff member has signed up for a Booking-Form session.';

$string['confirmationmessage_help'] = 'This message is sent out whenever users sign up for a session.';

$string['description_help'] = '**Description** is the course description that displays when a learner enrols on a Booking-Form session.
...
$string['emailmanagercancellation_help'] = 'When "Send notice to manager" is checked, an email will be sent to the learner\'s manager advising them that the Booking-Form booking has been cancelled.';

$string['emailmanagerconfirmation'] = '# Send notice to manager';
$string['emailmanagerconfirmation_help'] = 'When "Send notice to manager" is checked, a confirmation email will be sent to the learner\'s manager when the learner signs up for a Booking-Form session.';

$string['emailmanagerreminder'] = '# Send notice to manager';
$string['emailmanagerreminder_help'] = 'When "Send notice to manager" is checked, a reminder message will be sent to the learner\'s manager a few days before the start date of the Booking-Form session.';
...
$string['modulename_help'] = 'The Booking-Form activity module enables a teacher to set up a voluntary booking system for one or many in-person/classroom based sessions.

Each session within a Booking-Form activity can have customised settings around location, venue, start time, finish time, cost, capacity, etc. These can be set to run over multiple days or to allow for unscheduled and waitlisted sessions.
...
$string['mods_help'] = 'Booking-Form activities are used to keep track of in-person trainings which require advance booking.
...
$string['reminderinstrmngr_help'] = 'When **Send notice to manager** is checked, the text in the **Notice for Manager** field is sent to a learner\'s manager advising that they have signed up for a Booking-Form session.';
...
The **Request message** section displays the notices sent to the learner and their manager regarding the approval process for the learner to attend the Booking-Form session.

**Subject:** is the subject line that appears on the request approval emails sent to the manager and the learner.

**Message:** is the email text sent to the learner advising them that their request to attend the Booking-Form session has been sent to their manager for approval.

**Notice for manager:** is the email text sent to the learner\'s manager requesting approval to attend the Booking-Form session.';
...
* The staff member and the staff member\'s manager will be sent a confirmation email (i.e., the one formatted per the "Confirmation message" section of the Booking-Form instance\'s settings).
* The staff member will be sent a reminder email message (i.e., the one formatted per the "Reminder message" section of the Booking-Form instance\'s settings). The reminder will be sent a number of days before the session, according to the "Days before message is sent" setting also found in the "Reminder message" section of the Face-to-Face instance\'s settings.
...
* The staff member will be sent a confirmation email (i.e. the one formatted per the "Wait-listed message" section of the Booking-Form instance\'s settings).
...
$string['sessionsoncoursepage_help'] = 'This is the number of sessions for each Booking-Form activity that will be shown on the main course page.';
...
$string['showoncalendar_help'] = 'When **Site** is selected the Booking-Form activity sessions will be displayed on the site calendar as a Global Event.  All site users will be able to view these sessions.

When **Course** is selected all of the Booking-Form activity sessions will be displayed on the course calendar and as Course Event on the site level calendar and visible to all users enrolled in the course.

When **None** is selected, Booking-Form activity sessions will only be displayed as User Events on a confirmed attendee\'s calendar, provided the **Show on user\'s calendar** option has been selected.';

$string['suppressemail_help'] = 'Use this option if you want to silently add/remove users from a Booking-Form session. When this option is toggled, the usual email
...
$string['usercalentry_help'] = 'When active this setting adds a User Event entry to the calendar of an attendee of a Booking-Form session. When turned off this prevents a duplicate event appearing in a session attendee\'s calendar, where you have calendar display settings set to Course or Site.';
...
$string['eventcoursef2fviewed'] = 'Course Booking-Form instances viewed';
$string['eventcoursemoduleviewed'] = 'Booking-Form module instance viewed';
...
$string['emailnoshow_start'] =  '<p>Hello,
<br><br>
We sorry you missed your session. Here is a list of the upcoming sessions to schedule with your coach:
<br><br>
Upcoming sessions:
<br>
</p>
';
$string['emailnoshow_end'] = '<p>Best regards.</p>';
$string['emailnoshow_subject'] = 'Course Booking Information';