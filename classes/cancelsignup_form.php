...
class mod_bookingform_cancelsignup_form extends moodleform {

    public function definition() {
        $mform =& $this->_form;

        $mform->addElement('header', 'general', get_string('cancelbooking', 'bookingform'));
        ...
        $mform->addElement('html', get_string('cancellationconfirm', 'bookingform')); // Instructions.

        $mform->addElement('text', 'cancelreason', get_string('cancelreason', 'bookingform'), 'size="60" maxlength="255"');
